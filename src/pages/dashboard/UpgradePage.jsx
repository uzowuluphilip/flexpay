  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-brand-base px-4 pb-24 text-brand-text">
      <section className="w-full max-w-md rounded-[1.5rem] border border-brand-border/70 bg-[rgba(21,15,46,0.98)] p-6 shadow-[0_24px_70px_rgba(0,0,0,0.35)] sm:p-8">
        ...
        <ul className="mt-7 space-y-4 pl-5 text-sm leading-6 text-brand-muted"><li>Upload a clear <strong className="text-brand-text">payment screenshot</strong> immediately during transfer.</li></ul>
        <div className="mt-6 rounded-[1.25rem] border border-amber-400/30 bg-amber-400/5 p-4 text-sm leading-6 text-amber-200"><AlertTriangle className="mr-2 inline" size={17} />Avoid using <strong>Opay bank</strong>. Due to temporary network issues from Opay servers, payments made with Opay may not be confirmed. Please use <strong>any other Nigerian bank</strong> for instant confirmation.</div>
        <div className="mt-4 rounded-[1.25rem] border border-emerald-400/30 bg-emerald-400/5 p-4 text-sm leading-6 text-emerald-200"><CheckSquare className="mr-2 inline" size={17} />Payments made with other banks are confirmed within minutes.</div>
        <div className="mt-4 rounded-[1.25rem] border border-red-400/30 bg-red-400/5 p-4 text-sm leading-6 text-red-200"><X className="mr-2 inline" size={17} />Do not dispute your payment under any circumstances — disputes delay confirmation.</div>
