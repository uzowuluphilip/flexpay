...
const tiers = [
  { name: 'Starter', amount: 10000, icon: Zap, accent: 'from-[#6ee7b7] to-[#34d399]' },
...
export default function SpinPage() {
  ...
  const spin = async () => {
    ...
    setResult('')
    setError('')
    const stake = manualStake === '' ? selectedTier.amount : Number(manualStake)
