import { ArrowLeft, Banknote, Clipboard, CreditCard, ListChecks, ShieldCheck, Users } from 'lucide-react'
...
function WithdrawPage() {
  ...
  const requirements = tab === 'referrals'
    ? [{ icon: <Users size={18} />, title: 'Refer 3 friends', value: progress.referrals, target: 3, text: `${progress.referrals} / 3` }]
    : [
      { icon: <ListChecks size={18} />, title: 'Complete 15 daily tasks (no referrals needed)', value: progress.tasks, target: 15, text: `${progress.tasks} / 15` },
      { icon: <Clipboard size={18} />, title: 'Make 10 claims from your dashboard', value: progress.claims, target: 10, text: `${progress.claims} / 10` },
      { icon: <CreditCard size={18} />, title: 'Reach a balance of ₦200,000', value: progress.balance, target: 200000, text: `₦${progress.balance.toLocaleString()} / ₦200,000` },
    ]
