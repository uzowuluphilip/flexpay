...
function Hero() {
  ...
  return (
    <section id="top" ref={heroRef} className="relative isolate overflow-x-hidden px-4 pb-14 pt-[calc(4.75rem+env(safe-area-inset-top))] sm:px-6 sm:pb-20 lg:px-8 lg:pb-28 lg:pt-36">
      ...
      <div className="mx-auto grid min-h-[calc(100svh-6rem)] max-w-7xl items-center gap-6 sm:gap-8 lg:grid-cols-[1.08fr_0.92fr] lg:gap-12">
        <div className="mx-auto max-w-2xl text-center lg:mx-0 lg:text-left">
          ...
          <h1
            ref={headlineRef}
            className="font-display text-[2.7rem] leading-[0.93] text-brand-text sm:text-5xl lg:text-7xl"
          >
            Turn everyday activity into instant{' '}
            <span className="text-brand-lime">₦ rewards</span>.
          </h1>

          <p ref={subheadRef} className="mt-5 max-w-xl text-base leading-7 text-brand-muted sm:mt-6 sm:text-lg sm:leading-8 lg:text-xl">
          ...
          <div ref={ctaRef} className="mt-7 flex flex-col items-stretch gap-3 sm:mt-8 sm:flex-row sm:items-center sm:justify-start">
            <Link
              to="/register"
        ...
        <div
          ref={coinWrapRef}
          className="relative mx-auto flex min-h-[240px] w-full max-w-[560px] min-w-0 items-center justify-center overflow-hidden rounded-[1.5rem] border border-brand-border/80 bg-[radial-gradient(circle_at_top,_rgba(198,241,53,0.14),_transparent_50%)] p-2 shadow-[0_30px_120px_rgba(0,0,0,0.32)] sm:min-h-[360px] sm:p-6 md:min-h-[420px]"
